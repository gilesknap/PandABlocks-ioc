...
COPY --chmod=o+wrX . /workspaces/PandABlocks-ioc
WORKDIR /workspaces/PandABlocks-ioc
...
RUN git remote set-url origin git@github.com:PandABlocks/PandABlocks-ioc.git
